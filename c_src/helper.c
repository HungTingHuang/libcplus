...
CPLUS_UNIT_TEST(CPLUS_CONTAINER_OF, functionity)
{
    ...
    int32_t * t1pA = &(t1.A);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t1p = CPLUS_CONTAINER_OF(t1pA, struct test1, A)));
    ...
    int32_t * t1pB = &(t1.B);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t1p = CPLUS_CONTAINER_OF(t1pB, struct test1, B)));
    UNITTEST_EXPECT_EQ(true, t1p->A == t1.A);
    UNITTEST_EXPECT_EQ(true, t1p->B == t1.B);
    UNITTEST_EXPECT_EQ(true, t1p->C == t1.C);
    UNITTEST_EXPECT_EQ(true, t1p->D == t1.D);
    UNITTEST_EXPECT_EQ(true, t1p->E == t1.E);
    int32_t * t1pC = &(t1.C);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t1p = CPLUS_CONTAINER_OF(t1pC, struct test1, C)));
    UNITTEST_EXPECT_EQ(true, t1p->A == t1.A);
    UNITTEST_EXPECT_EQ(true, t1p->B == t1.B);
    UNITTEST_EXPECT_EQ(true, t1p->C == t1.C);
    UNITTEST_EXPECT_EQ(true, t1p->D == t1.D);
    UNITTEST_EXPECT_EQ(true, t1p->E == t1.E);
    int32_t * t1pD = &(t1.D);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t1p = CPLUS_CONTAINER_OF(t1pD, struct test1, D)));
    UNITTEST_EXPECT_EQ(true, t1p->A == t1.A);
    UNITTEST_EXPECT_EQ(true, t1p->B == t1.B);
    UNITTEST_EXPECT_EQ(true, t1p->C == t1.C);
    UNITTEST_EXPECT_EQ(true, t1p->D == t1.D);
    UNITTEST_EXPECT_EQ(true, t1p->E == t1.E);
    int32_t * t1pE = &(t1.E);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t1p = CPLUS_CONTAINER_OF(t1pE, struct test1, E)));
    UNITTEST_EXPECT_EQ(true, t1p->A == t1.A);
    UNITTEST_EXPECT_EQ(true, t1p->B == t1.B);
    UNITTEST_EXPECT_EQ(true, t1p->C == t1.C);
    UNITTEST_EXPECT_EQ(true, t1p->D == t1.D);
    ...
    int8_t * t2pA = &(t2.A);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t2p = CPLUS_CONTAINER_OF(t2pA, struct test2, A)));
    ...
    int8_t * t2pB = &(t2.B);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t2p = CPLUS_CONTAINER_OF(t2pB, struct test2, B)));
    UNITTEST_EXPECT_EQ(true, t2p->A == t2.A);
    UNITTEST_EXPECT_EQ(true, t2p->B == t2.B);
    UNITTEST_EXPECT_EQ(true, t2p->C == t2.C);
    UNITTEST_EXPECT_EQ(true, t2p->D == t2.D);
    UNITTEST_EXPECT_EQ(true, t2p->E == t2.E);
    int8_t * t2pC = &(t2.C);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t2p = CPLUS_CONTAINER_OF(t2pC, struct test2, C)));
    UNITTEST_EXPECT_EQ(true, t2p->A == t2.A);
    UNITTEST_EXPECT_EQ(true, t2p->B == t2.B);
    UNITTEST_EXPECT_EQ(true, t2p->C == t2.C);
    UNITTEST_EXPECT_EQ(true, t2p->D == t2.D);
    UNITTEST_EXPECT_EQ(true, t2p->E == t2.E);
    int8_t * t2pD = &(t2.D);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t2p = CPLUS_CONTAINER_OF(t2pD, struct test2, D)));
    UNITTEST_EXPECT_EQ(true, t2p->A == t2.A);
    UNITTEST_EXPECT_EQ(true, t2p->B == t2.B);
    UNITTEST_EXPECT_EQ(true, t2p->C == t2.C);
    UNITTEST_EXPECT_EQ(true, t2p->D == t2.D);
    UNITTEST_EXPECT_EQ(true, t2p->E == t2.E);
    int8_t * t2pE = &(t2.E);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t2p = CPLUS_CONTAINER_OF(t2pE, struct test2, E)));
    UNITTEST_EXPECT_EQ(true, t2p->A == t2.A);
    UNITTEST_EXPECT_EQ(true, t2p->B == t2.B);
    UNITTEST_EXPECT_EQ(true, t2p->C == t2.C);
    UNITTEST_EXPECT_EQ(true, t2p->D == t2.D);
    ...
    int16_t * t3pA = &(t3.A);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t3p = CPLUS_CONTAINER_OF(t3pA, struct test3, A)));
    ...
    int16_t * t3pB = &(t3.B);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t3p = CPLUS_CONTAINER_OF(t3pB, struct test3, B)));
    UNITTEST_EXPECT_EQ(true, t3p->A == t3.A);
    UNITTEST_EXPECT_EQ(true, t3p->B == t3.B);
    UNITTEST_EXPECT_EQ(true, t3p->C == t3.C);
    UNITTEST_EXPECT_EQ(true, t3p->D == t3.D);
    UNITTEST_EXPECT_EQ(true, t3p->E == t3.E);
    int16_t * t3pC = &(t3.C);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t3p = CPLUS_CONTAINER_OF(t3pC, struct test3, C)));
    UNITTEST_EXPECT_EQ(true, t3p->A == t3.A);
    UNITTEST_EXPECT_EQ(true, t3p->B == t3.B);
    UNITTEST_EXPECT_EQ(true, t3p->C == t3.C);
    UNITTEST_EXPECT_EQ(true, t3p->D == t3.D);
    UNITTEST_EXPECT_EQ(true, t3p->E == t3.E);
    int16_t * t3pD = &(t3.D);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t3p = CPLUS_CONTAINER_OF(t3pD, struct test3, D)));
    UNITTEST_EXPECT_EQ(true, t3p->A == t3.A);
    UNITTEST_EXPECT_EQ(true, t3p->B == t3.B);
    UNITTEST_EXPECT_EQ(true, t3p->C == t3.C);
    UNITTEST_EXPECT_EQ(true, t3p->D == t3.D);
    UNITTEST_EXPECT_EQ(true, t3p->E == t3.E);
    int16_t * t3pE = &(t3.E);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t3p = CPLUS_CONTAINER_OF(t3pE, struct test3, E)));
    UNITTEST_EXPECT_EQ(true, t3p->A == t3.A);
    UNITTEST_EXPECT_EQ(true, t3p->B == t3.B);
    UNITTEST_EXPECT_EQ(true, t3p->C == t3.C);
    UNITTEST_EXPECT_EQ(true, t3p->D == t3.D);
    ...
    int64_t * t4pA = &(t4.A);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t4p = CPLUS_CONTAINER_OF(t4pA, struct test4, A)));
    ...
    int64_t * t4pB = &(t4.B);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t4p = CPLUS_CONTAINER_OF(t4pB, struct test4, B)));
    UNITTEST_EXPECT_EQ(true, t4p->A == t4.A);
    UNITTEST_EXPECT_EQ(true, t4p->B == t4.B);
    UNITTEST_EXPECT_EQ(true, t4p->C == t4.C);
    UNITTEST_EXPECT_EQ(true, t4p->D == t4.D);
    UNITTEST_EXPECT_EQ(true, t4p->E == t4.E);
    int64_t * t4pC = &(t4.C);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t4p = CPLUS_CONTAINER_OF(t4pC, struct test4, C)));
    UNITTEST_EXPECT_EQ(true, t4p->A == t4.A);
    UNITTEST_EXPECT_EQ(true, t4p->B == t4.B);
    UNITTEST_EXPECT_EQ(true, t4p->C == t4.C);
    UNITTEST_EXPECT_EQ(true, t4p->D == t4.D);
    UNITTEST_EXPECT_EQ(true, t4p->E == t4.E);
    int64_t * t4pD = &(t4.D);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t4p = CPLUS_CONTAINER_OF(t4pD, struct test4, D)));
    UNITTEST_EXPECT_EQ(true, t4p->A == t4.A);
    UNITTEST_EXPECT_EQ(true, t4p->B == t4.B);
    UNITTEST_EXPECT_EQ(true, t4p->C == t4.C);
    UNITTEST_EXPECT_EQ(true, t4p->D == t4.D);
    UNITTEST_EXPECT_EQ(true, t4p->E == t4.E);
    int64_t * t4pE = &(t4.E);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t4p = CPLUS_CONTAINER_OF(t4pE, struct test4, E)));
    UNITTEST_EXPECT_EQ(true, t4p->A == t4.A);
    UNITTEST_EXPECT_EQ(true, t4p->B == t4.B);
    UNITTEST_EXPECT_EQ(true, t4p->C == t4.C);
    UNITTEST_EXPECT_EQ(true, t4p->D == t4.D);
    ...
    int32_t * t5pA = &(t5.A);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t5p = CPLUS_CONTAINER_OF(t5pA, struct test5, A)));
    ...
    int8_t * t5pB = &(t5.B);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t5p = CPLUS_CONTAINER_OF(t5pB, struct test5, B)));
    UNITTEST_EXPECT_EQ(true, t5p->A == t5.A);
    UNITTEST_EXPECT_EQ(true, t5p->B == t5.B);
    UNITTEST_EXPECT_EQ(true, t5p->C == t5.C);
    UNITTEST_EXPECT_EQ(true, t5p->D == t5.D);
    UNITTEST_EXPECT_EQ(true, t5p->E == t5.E);
    int16_t * t5pC = &(t5.C);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t5p = CPLUS_CONTAINER_OF(t5pC, struct test5, C)));
    UNITTEST_EXPECT_EQ(true, t5p->A == t5.A);
    UNITTEST_EXPECT_EQ(true, t5p->B == t5.B);
    UNITTEST_EXPECT_EQ(true, t5p->C == t5.C);
    UNITTEST_EXPECT_EQ(true, t5p->D == t5.D);
    UNITTEST_EXPECT_EQ(true, t5p->E == t5.E);
    int8_t * t5pD = &(t5.D);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t5p = CPLUS_CONTAINER_OF(t5pD, struct test5, D)));
    UNITTEST_EXPECT_EQ(true, t5p->A == t5.A);
    UNITTEST_EXPECT_EQ(true, t5p->B == t5.B);
    UNITTEST_EXPECT_EQ(true, t5p->C == t5.C);
    UNITTEST_EXPECT_EQ(true, t5p->D == t5.D);
    UNITTEST_EXPECT_EQ(true, t5p->E == t5.E);
    int64_t * t5pE = &(t5.E);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t5p = CPLUS_CONTAINER_OF(t5pE, struct test5, E)));
    UNITTEST_EXPECT_EQ(true, t5p->A == t5.A);
    UNITTEST_EXPECT_EQ(true, t5p->B == t5.B);
    UNITTEST_EXPECT_EQ(true, t5p->C == t5.C);
    UNITTEST_EXPECT_EQ(true, t5p->D == t5.D);
    ...
    int8_t * t6pA = &(t6.A);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t6p = CPLUS_CONTAINER_OF(t6pA, struct test6, A)));
    ...
    int16_t * t6pB = &(t6.B);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t6p = CPLUS_CONTAINER_OF(t6pB, struct test6, B)));
    UNITTEST_EXPECT_EQ(true, t6p->A == t6.A);
    UNITTEST_EXPECT_EQ(true, t6p->B == t6.B);
    UNITTEST_EXPECT_EQ(true, t6p->C == t6.C);
    UNITTEST_EXPECT_EQ(true, t6p->D == t6.D);
    UNITTEST_EXPECT_EQ(true, t6p->E == t6.E);
    int8_t * t6pC = &(t6.C);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t6p = CPLUS_CONTAINER_OF(t6pC, struct test6, C)));
    UNITTEST_EXPECT_EQ(true, t6p->A == t6.A);
    UNITTEST_EXPECT_EQ(true, t6p->B == t6.B);
    UNITTEST_EXPECT_EQ(true, t6p->C == t6.C);
    UNITTEST_EXPECT_EQ(true, t6p->D == t6.D);
    UNITTEST_EXPECT_EQ(true, t6p->E == t6.E);
    int64_t * t6pD = &(t6.D);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t6p = CPLUS_CONTAINER_OF(t6pD, struct test6, D)));
    UNITTEST_EXPECT_EQ(true, t6p->A == t6.A);
    UNITTEST_EXPECT_EQ(true, t6p->B == t6.B);
    UNITTEST_EXPECT_EQ(true, t6p->C == t6.C);
    UNITTEST_EXPECT_EQ(true, t6p->D == t6.D);
    UNITTEST_EXPECT_EQ(true, t6p->E == t6.E);
    int32_t * t6pE = &(t6.E);
    UNITTEST_EXPECT_EQ(true, CPLUS_NULL != (t6p = CPLUS_CONTAINER_OF(t6pE, struct test6, E)));
    UNITTEST_EXPECT_EQ(true, t6p->A == t6.A);
    UNITTEST_EXPECT_EQ(true, t6p->B == t6.B);
    UNITTEST_EXPECT_EQ(true, t6p->C == t6.C);
    UNITTEST_EXPECT_EQ(true, t6p->D == t6.D);
