...
CPLUS_UNIT_TEST(cplus_file_new, functionity)
{
	...
	UNITTEST_EXPECT_EQ(true, (CPLUS_NULL != (file = cplus_file_new_ex(
...
CPLUS_UNIT_TEST(cplus_file_get_data, functionity)
{
	...
	UNITTEST_EXPECT_EQ(true, (true == cplus_file_is_exist((char *)(TEST_FILE))));
	UNITTEST_EXPECT_EQ(strlen(TEST_STR), cplus_file_write(file, strlen(TEST_STR), (void *)(TEST_STR)));
	UNITTEST_EXPECT_EQ(true, (CPLUS_NULL != (bufs = cplus_file_get_data(file))));
