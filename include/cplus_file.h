...
{
    CPLUS_FILE_FLAG_NONE        = 0,
    CPLUS_FILE_FLAG_CREATE      = O_CREAT,
    CPLUS_FILE_FLAG_EXCL        = O_EXCL,
    CPLUS_FILE_FLAG_NOCTTY      = O_NOCTTY,
    CPLUS_FILE_FLAG_TRUNC       = O_TRUNC,
    CPLUS_FILE_FLAG_APPEND      = O_APPEND,
    CPLUS_FILE_FLAG_NONBLOCK    = O_NONBLOCK,
    CPLUS_FILE_FLAG_SYNC        = O_SYNC,
    CPLUS_FILE_FLAG_FASYNC      = FASYNC,
    // CPLUS_FILE_FLAG_DIRECT      = O_DIRECT,
    // CPLUS_FILE_FLAG_LARGEFILE   = O_LARGEFILE,
    CPLUS_FILE_FLAG_DIRECTORY   = O_DIRECTORY,
    CPLUS_FILE_FLAG_NOFOLLOW    = O_NOFOLLOW,
    // CPLUS_FILE_FLAG_NOATIME     = O_NOATIME,
    CPLUS_FILE_FLAG_CLOEXEC     = O_CLOEXEC,
    CPLUS_FILE_FLAG_NDELAY      = O_NDELAY,
} CPLUS_FILE_FLAG;
