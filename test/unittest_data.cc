...
TEST(cplus_data_new_ex, all_type)
{
	...
	EXPECT_EQ(0, strcmp("test_uint64", cplus_data_get_key(data)));
	EXPECT_EQ(CPLUS_SUCCESS, cplus_data_delete(data));
	EXPECT_EQ(CPLUS_TRUE, CPLUS_NULL != (data = cplus_data_new_float_ex(3.1415926535, sizeof("test_float"), "test_float")));
	EXPECT_EQ(0, strcmp("test_float", cplus_data_get_key(data)));
	EXPECT_EQ(CPLUS_SUCCESS, cplus_data_delete(data));
	EXPECT_EQ(CPLUS_TRUE, CPLUS_NULL != (data = cplus_data_new_double_ex(3.1415926535,sizeof("test_double"), "test_double")));
	EXPECT_EQ(0, strcmp("test_double", cplus_data_get_key(data)));
	EXPECT_EQ(CPLUS_SUCCESS, cplus_data_delete(data));
	EXPECT_EQ(CPLUS_TRUE, CPLUS_NULL != (data = cplus_data_new_pointer_ex(&v1, sizeof("test_pointer"), "test_pointer")));
	EXPECT_EQ(0, strcmp("test_pointer", cplus_data_get_key(data)));
	EXPECT_EQ(CPLUS_SUCCESS, cplus_data_delete(data));
